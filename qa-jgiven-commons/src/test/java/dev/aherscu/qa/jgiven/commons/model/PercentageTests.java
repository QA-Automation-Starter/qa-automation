...
public class PercentageTests {
    ...
    public final void shouldSerialize() {
        assertThat(toJson(Foo.builder()
            .percentage(new DoublePercentage(0.12356))
            .build()),
            equalToCompressingWhiteSpace("{\"percentage\":0.12356}"));
    }

    @Test
    public final void shouldDeserialize() {
        assertThat(fromJson("{\"percentage\":0.12356}", Foo.class),
            equalTo(Foo.builder()
                .percentage(new DoublePercentage(0.12356))
                .build()));
    }
    ...
    @EqualsAndHashCode
    static class Foo {
        public final DoublePercentage percentage;
    }
}