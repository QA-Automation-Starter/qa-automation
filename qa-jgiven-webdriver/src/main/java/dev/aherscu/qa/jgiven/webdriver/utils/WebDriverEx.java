...
public class WebDriverEx {
     ...
     * {@link #remoteSessions} mapped to name of test as defined in
     * UnitilsScenarioTest#unitilsBeforeClass or
     * UnitilsScenarioTest#unitilsBeforeMethod
     * </p>
     *
     * @param capabilities
    ...
    public String webContextIdentifier() {
        ...
        return Failsafe.with(
            ...
            new RetryPolicy<String>()
                // at most 3 retries by default
                .withMaxDuration(WebDriverStageEx.pollTimeout)
