...
import static dev.aherscu.qa.jgiven.webdriver.utils.WebDriverEx.*;
import static dev.aherscu.qa.jgiven.webdriver.utils.WebDriverStageEx.scrollIntoViewTimer;
...
public class WebDriverFixtures<SELF extends WebDriverFixtures<SELF>>
    ...
    @Delegate
    protected final WebDriverStageEx<SELF>   webDriverStageEx =
        new WebDriverStageEx<SELF>() {
                                                                      /**
                                                                       * Scrolls
                                                                       * specified
                                                                       * element
                                                                      ...
                                                                      public WebElement scrollIntoView(
                                                                          ...
                                                                          try (
                                                                              val scrollIntoViewTimerContext =
                                                                                  scrollIntoViewTimer
                                                                                      .time()) {
                                                                              log.debug(
                                                                                  "scrolling to {}",
