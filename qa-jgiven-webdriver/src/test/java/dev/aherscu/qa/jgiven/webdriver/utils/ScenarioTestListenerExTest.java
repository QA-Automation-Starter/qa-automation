...
import static dev.aherscu.qa.jgiven.webdriver.utils.ScenarioTestListenerEx.*;
...
public class ScenarioTestListenerExTest {
    ...
    private static ITestClass mockedTestClassFor(final String aClass) {
        val mockedTestClass = Mockito.mock(ITestClass.class);
        Mockito.when(mockedTestClass.getName())
            .thenReturn(aClass);
    ...
    private static TestRunner mockedTestRunner(
        ...
        val mockedTestContext = Mockito.mock(TestRunner.class);
        Mockito.when(mockedTestContext.getAttribute(REPORT_MODELS_ATTRIBUTE))
            .thenReturn(reportModels);
        Mockito.when(mockedTestContext.getTestClasses())
    ...
    public void beforeClassPopulateReportModel() {
        ...
        new ScenarioTestListenerEx(
            Mockito.mock(CommonReportHelper.class),
