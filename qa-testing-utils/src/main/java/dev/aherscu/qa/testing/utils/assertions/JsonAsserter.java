...
public interface JsonAsserter {
    ...
    /**
     * Asserts that object specified by path satisfies the condition specified
     * by matcher. If not, an AssertionError is thrown with information about
     ...
     * @param <T>
     *            the static type that should be returned by the path
     * @return this to allow fluent assertion chains
     */
    <T> JsonAsserter assertThat(String path, Matcher<T> matcher,
        String message);
    ...
    /**
     * Asserts that object specified by path is equal to the expected value. If
     * they are not, an AssertionError is thrown with the given message.
     *
     * @param path
     *            the json path specifying the value being compared
     * @param expected
    ...
    /**
     * Checks that a path is not defined within a document. If the document
     * contains the given path, an AssertionError is thrown
     *
     * @param path
     *            the path to make sure not exists
     * @return this
     */
    ...
    /**
     * Asserts that object specified by path is null. If it is not, an
     * AssertionError is thrown with the given message.
     *
     * @param path
     *            the json path specifying the value that should be null
     * @return this to allow fluent assertion chains
     */
    ...
    /**
     * Asserts that object specified by path is NOT null. If it is, an
     * AssertionError is thrown with the given message.
     *
     * @param path
